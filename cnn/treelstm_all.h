#ifndef CNN_TREELSTM_ALL_H_
#define CNN_TREELSTM_ALL_H_
...
struct TreeLSTMAllBuilder : public RNNBuilder {
  TreeLSTMAllBuilder() = default;
  explicit TreeLSTMAllBuilder(unsigned N, //Max branching factor
                       unsigned layers,
                       unsigned input_dim,
                       unsigned hidden_dim,
                       Model* model);
 ...
 public:
  ...
  std::vector<std::vector<Parameters*>> lparams;
  std::vector<std::vector<Parameters*>> rparams;
  // first index is layer, then ...
  std::vector<std::vector<Expression>> param_vars;
  std::vector<std::vector<Expression>> lparam_vars;
  std::vector<std::vector<Expression>> rparam_vars;
