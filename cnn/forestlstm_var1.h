#ifndef CNN_FORESTLSTM_VAR1_H_
#define CNN_FORESTLSTM_VAR1_H_
...
struct ForestLSTMBuilder_var1 : public RNNBuilder {
  ForestLSTMBuilder_var1() = default;
  explicit ForestLSTMBuilder_var1(unsigned N, //Max branching factor
		       unsigned layers,
                       unsigned input_dim,
                       unsigned hidden_dim,
                       Model* model);
